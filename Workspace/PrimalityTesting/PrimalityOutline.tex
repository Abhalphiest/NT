...
There is another way to possibly ease the difficulty of factorizing $n - 1$, namely by using a different compositeness test than Fermat's
theorem, that allows us to attempt to factorize a different number than $N - 1$, which may prove easier.  
\subsubsection{Lucas Sequences and Lucasian Primality Tests}
